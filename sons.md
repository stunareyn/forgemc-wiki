...
* Sons conservés au Prestige et à la Renaissance.
...
| Pierre | Peu commun | `block.deepslate.break` | Collection Overworld, 8 minerais au palier II |
...
| Aube | Épique | `block.respawn_anchor.charge` | Renaissance 2 |
| Tintement | Légendaire | `block.note_block.pling`, volume 0,4 | Collection Armures, 15 armures complètes |
| Éternité | Mythique | `block.end_portal_frame.fill` | Renaissance 7 |
